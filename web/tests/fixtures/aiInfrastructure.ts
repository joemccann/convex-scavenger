...
export const aiFixture: AiSnapshot = {
  ...
  sources: [{ id: "fixture", name: "Fixture publisher", url: "https://example.com/evidence", status: "available", reason: "Synthetic verification fixture", checked_at: "2026-09-07T12:00:00Z", cadence: "daily", license: "test only", lineage_group: "fixture-host" }],
